...
<TestCase name="Agile_Test" version="5">

<meta>
   <create version="7.1" buildNumber="7.1.0.611" author="admin" date="09/24/2014" host="GH-6K1JRY1" />
   <lastEdited version="7.1" buildNumber="7.1.0.611" author="e047494" date="09/29/2014" host="GH-6K1JRY1" />
</meta>

<id>F8F3D8D843FB11E4B7B1F01FAF3E427F</id>
<Documentation>Put documentation of the Test Case here.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9MiZ0Y3Y9NSZsaXNhdj03LjEgKDcuMS4wLjYxMSkmbm9kZXM9LTI0OTM3MTk3Nw==</sig>
...
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <prop>lisa.Agile Test Case.http.responseCode</prop>
        <param>200</param>
</CheckResult>
...
<url>https://outboundproxy.mclocal.int:15520/demo/AccelaLoanProcess/PostDepositFunds.php?x_accela_login_id=tt5682bv2s&amp;x_accela_login_key=Pvx7829b!v9&amp;x_card_number={{cardNum}}&amp;x_expiration_date=1216&amp;x_email_address=email%40domain.com&amp;x_loan_reference_id={{loanReferenceId}}&amp;x_amount=1.00&amp;x_account_type=Checking&amp;x_soft_descriptor=John1234</url>
...
<onError>abort</onError>
    ...
    <Node name="end" log=""
          ...
          version="1" 
          uid="F8F3D8DE43FB11E4B7B1F01FAF3E427F" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="fail" > 
    ...
    <Node name="fail" log=""
          ...
          version="1" 
          uid="F8F3D8DC43FB11E4B7B1F01FAF3E427F" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="abort" > 
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="F8F3D8DA43FB11E4B7B1F01FAF3E427F" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="" > 
    ...
    <DataSet type="com.itko.lisa.test.DataSetRandIDGenerator" name="loanReferenceId" atend="" local="true" random="false" maxItemsToFetch="0" >
...
<prefix></prefix>
    ...
    <DataSet type="com.itko.lisa.test.DataSheet" name="bin" atend="end" local="true" random="false" maxItemsToFetch="100" >
<sample>rO0ABXNyABFqYXZhLnV0aWwuSGFzaE1hcAUH2sHDFmDRAwACRgAKbG9hZEZhY3RvckkACXRocmVzaG9sZHhwP0AAAAAAAAF3CAAAAAIAAAACdAAKYmluX1Jvd051bXQAATF0AANiaW50AAsxMzEwMDAwMjA5MHg=</sample>
<table>
<col>bin</col>
<tr>
<td>13100002090</td>
...
<td>54313200501</td>
    ...
    <DataSet type="com.itko.lisa.test.DataSetRandIDGenerator" name="RandomNumber" atend="" local="true" random="false" maxItemsToFetch="100" >
<sample>rO0ABXNyABFqYXZhLnV0aWwuSGFzaE1hcAUH2sHDFmDRAwACRgAKbG9hZEZhY3RvckkACXRocmVzaG9sZHhwP0AAAAAAAAB3CAAAAAEAAAABdAAMUmFuZG9tTnVtYmVydAAEMTU1NXg=</sample>
<type>Numeric</type>
<length>4</length>
<prefix></prefix>
    </DataSet>
